...
def registerResources():
    ...
    api.add_resource(PostAuthorResource, '/post/author/<int:atuhrorid>', endpoint='get_post_by_author')
    api.add_resource(PostCategoryResource, '/post/category/<int:categoryid>', endpoint='get_post_by_category')
